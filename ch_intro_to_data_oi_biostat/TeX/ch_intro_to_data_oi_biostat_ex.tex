...
Since exploratory data analysis relies heavily on the use of computation, refer to the labs for exercises related to this section, which are free and may be found at \oiRedirect{biostat}{\textbf{\color{black}openintro.org/book/biostat}}.