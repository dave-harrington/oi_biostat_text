...
\eoce{\qt{Prevalence difference versus prevalence ratio, I.} 
  ...
  \item Assume that the prevalence for a particular disease in two groups
    is 40.4\% and 42\%.  Calculate the prevalence difference and ratio for the disease, comparing the group with the higher prevalence to the one with the lower prevalence.

  \item Now assume that the prevalence for a particular disease in two groups is 1.2\% and 2.8\%.  Calculate the prevalence difference and ratio for the disease, comparing the group with the higher prevalence to the one with the lower prevalence.

  \item Which measure for comparing prevalence do you think is the more informative in each of the these two situations?
...
\eoce{\qt{Prevalence difference versus prevalence ratio, II.} 
  ...
  \item Assume that the prevalence for a particular disease in two groups
    is 10\% and 15\$.  Calculate the prevalence difference and ratio for the disease, comparing the group with the higher prevalence to the one with the lower prevalence.

  \item Now assume that the prevalence for a particular disease in two groups is 40\% and 45\%.  Calculate the prevalence difference and ratio for the disease, comparing the group with the higher prevalence to the one with the lower prevalence.
...
\begin{parts}
 ...
 \item Verify that the $\chi^2$-statistic has value 9.77.
