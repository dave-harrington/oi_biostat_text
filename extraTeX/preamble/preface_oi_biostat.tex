...
\oiRedirect{textbook-openintro_about}{OpenIntro Staff} and the many faculty, students and readers who commented on all the editions of \textit{OpenIntro Statistics}.
