...
\newcommand{\chapterintro}[1]{
  ...
  \noindent%
  \oiRedirect{stat}{\includegraphics[height=10mm]{extraTeX/icons/labs_and_slides.png}}
  \vspace{5mm}
  ...
  {\Large\noindent%
  For labs, slides, and other resources, please visit \\[2mm]
  \oiRedirect{biostat}{\textbf{\color{oiB}www.openintro.org/book/biostat}}}%
      \vspace{5mm}
