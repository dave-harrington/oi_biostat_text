...
% solutions to all problems in dropbox file eoce_logistic_sols.tex
...
% EVEN TB treatment interruption and secondary education
% needs solution, but should probably be replaced
...
% ODD interaction in regression I
