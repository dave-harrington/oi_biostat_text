...
(c)~The estimates of the standard errors in the table are the same as those calculated for estimates of log(OR)s in a two-way table discussed in
}

\begin{comment}
% even problem, emergency room outcomes, III
\eocesol{Emergency room outcomes in Denmark, III.  Needs solution.
}{}
\end{comment}
...
\begin{comment}
\eocesol{
	Even problem. Interaction in regression, II.  Needs a solution
}
\end{comment}

\eocesol{
Odd problem.  Smoking and marijuana use, I	
}{}

\begin{comment}
\eocesol{
Even problem.  Smoking and marijuana use, II
}{}
\end{comment}
