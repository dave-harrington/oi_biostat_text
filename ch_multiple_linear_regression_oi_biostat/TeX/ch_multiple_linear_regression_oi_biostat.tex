...
\begin{chapterpage}{Multiple linear regression}
  ...
  \chaptersection{multLinRegrExercises}%
  \vspace{-20mm}
\end{chapterpage}
...
\label{section:adjustedRSquared}
